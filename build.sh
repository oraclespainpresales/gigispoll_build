...
echo Unzip VBCS app...
ssh -i /tmp/build/nopassphrase.key -o "StrictHostKeyChecking=no" opc@${publicip} 'sudo unzip /tmp/built-assets.zip -d /usr/share/nginx/html/gigispoll;sudo chown -R nginx:nginx gigispoll/'
