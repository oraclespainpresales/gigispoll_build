...
echo ${publicip}
echo Wait until Compute SSH cpnnection is available...
chmod 600 nopassphrase.key
ssh -i nopassphrase.key  -o "ConnectTimeout=5" -o "ConnectionAttempts=10" -o "StrictHostKeyChecking=no" opc@${publicip} 'exit'
